...
feature "List of lettings" do
  ...
  scenario "shows you confirmed the booking" do
    tenant = User.create(email: "test@test.com", username: "brian", password: "Testlength123")
    landlord = User.create(email: "leech@test.com", username: "parasite", password: "Testlength123")
  ...
  scenario "removes the booking when you reject" do
    tenant = User.create(email: "test@test.com", username: "brian", password: "Testlength123")
    landlord = User.create(email: "leech@test.com", username: "parasite", password: "Testlength123")
    ...
    expect(page).to have_button("REJECT")
    click_button 'REJECT'
    expect(page).not_to have_content(space.headline)
    expect(page).not_to have_content("19/04/21 - 21/04/21")
